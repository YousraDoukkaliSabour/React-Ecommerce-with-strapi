...
const Main = () => {
  ...
  const menCategoryAPI =
    "products?populate=*&filters[productCategorie][$eq]=men";
  const womenCategoryAPI =
    "products?populate=*&filters[productCategorie][$eq]=women";
        ...
        >
          <Box>
            ...
            <Typography fontWeight={300} variant="body1">
              All our new arrivals in a exlusive brand selection
            </Typography>
          </Box>
